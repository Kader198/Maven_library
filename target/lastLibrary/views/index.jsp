...
<div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModallabel" aria-hidden="true">
    ...
    <script >
        function openEditModalBook(libelle,cout,auteur){
            console.log(libelle,cout,auteur);
            document.getElementById("editLibelle").innerText = libelle;
            document.getElementById("editCout").innerText = cout;
            document.getElementById("editAuteur").innerText = auteur;
        }
    </script>
